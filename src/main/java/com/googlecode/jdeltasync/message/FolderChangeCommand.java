...
/**
 * {@link Command} exchanged when a folder has been changed.
 */
public class FolderChangeCommand extends AbstractFolderDetailsCommand {
	/**
	@see AbstractFolderDetailsCommand#AbstractFolderDetailsCommand(java.lang.String, java.lang.String, java.lang.String)
	*/
	public FolderChangeCommand(String id, String displayName, String parentID) {
